...
class Mating:
    ...
    def do_variation(self, pool, random, geometry, constraints, id_generator,
        ...
        offspring_cell = self.merge_sites(offspring_cell, geometry,
                                          constraints)
        #print('variations.py line 254:',offspring_cell) 
...
class StructureMut(object):
    ...
    def do_variation(self, pool, random, geometry, constraints, id_generator,
        ...
        #print('variations.py line 848:', offspring)
...
class NumAtomsMut(object):
    ...
    def do_variation(self, pool, random, geometry, constraints, id_generator,
        ...
        if len(composition_space.endpoints) == 0:
            if num_adds > 0:
        ...
        offspring = Organism(cell, id_generator, self.name, composition_space)
        #print('variations.py line 1088:', offspring)
        offspring.parents = (parent_org.id)
        #print('Creating offspring organism {} from parent organism {} with '
...
class Permutation(object):
    ...
    def do_variation(self, pool, random, geometry, constraints, id_generator,
        ...
        if parent_org is None:
            #print('variations.py line 1350: could not find parent for permutation')
            return None
        ...
        offspring = Organism(cell, id_generator, self.name, composition_space)
        #print('variations.py line 1370:', offspring)
        offspring.parents = (parent_org.id)
        #print('Creating offspring organism {} from parent organism {} with '
