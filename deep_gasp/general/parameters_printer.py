    ...
    with open(os.getcwd() + '/ga_parameters', 'w') as parameters_file:
        ...
        for creator in organism_creators:
            if creator.name == 'random organism creator':
                ...
                parameters_file.write('        allow_binary: ' +
                                      str(creator.allow_binary) + '\n')
        ...
        parameters_file.write('    allow_binary: ' +
                              str(constraints.allow_binary) + '\n')
        parameters_file.write('    allow_magmom: ' +
                              str(constraints.allow_magmom) + '\n')
        if constraints.allow_magmom == True:
            parameters_file.write('    magmom: ' +
                              str(constraints.magmom) + '\n')
