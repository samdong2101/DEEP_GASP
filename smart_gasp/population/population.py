...
class InitialPopulation():
    ...
    def add_organism(self, organism_to_add, composition_space):
        ...
        organism_to_add.cell.to(fmt = 'poscar', filename = os.getcwd() + '/initial_population/POSCAR.' +
...
class Pool(object):
    ...
    def add_organism(self, organism_to_add, composition_space):
        ...
        try:
            ...
            pass
        organism_to_add.cell.to(fmt = 'poscar', filename = os.getcwd() +'/offspring' + '/POSCAR.' +
                                str(organism_to_add.id))
        organism_to_add.is_active = True
    ...
    def compute_pd_values(self, organisms_list, composition_space):
        ...
        elements = [i.elements[0] for i in composition_space.endpoints]
